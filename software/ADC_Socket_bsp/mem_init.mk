...
$(MEM_1).dat: $(MEM_1).flash
	$(post-process-info)
	$(MKDIR) -p $(@D)
	$(FLASH2DAT) --infile=$< --outfile=$@ \
		--base=0x0 --end=0x7ffffff --width=$(mem_width) \
		--create-lanes=$(mem_create_lanes) $(flash2dat_extra_args)


FLASH_DAT_FILES += $(MEM_1).dat
...
$(MEM_2)_END := 0x0837ffff
$(MEM_2)_SPAN := 0x00180000
