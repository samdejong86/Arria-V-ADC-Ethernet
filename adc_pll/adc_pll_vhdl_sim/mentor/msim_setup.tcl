...
# ----------------------------------------
# If adc_pll_vhdl is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 linux 2018.05.04.13:58:32
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "adc_pll_vhdl"
}
...
alias dev_com {
  ...
  if ![ string match "*ModelSim ALTERA*" [ vsim -version ] ] {
    ...
    eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/arriav_atoms_ncrypt.v"     -work arriav      
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/adc_pll_vhdl.vho"
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
